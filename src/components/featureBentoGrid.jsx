...
export function FeaturesSectionDemo() {
  const features = [
    ...
    },
    {
      ...
      description:
        "Multi-Business Support: Whether you're in e-commerce, education, retail, B2B services, or any other sector, our solution is built to support all business types.",
      skeleton: <SkeletonTwo />,
      className: "border-b col-span-1 lg:col-span-2 dark:border-neutral-800",
    },
    {
      title: "Watch our Services on YouTube",
      description:
    ...
    },
    {
      ...
      description:
        "Our team is available 24/7 to provide assistance and resolve issues quickly, ensuring smooth operations and customer satisfaction.",
      skeleton: <SkeletonFour />,
      className: "col-span-1 lg:col-span-3 border-b lg:border-none",
    },
  ];
  return (
    (<div className="relative bg-grey-50 z-20 py-2 lg:py-6 max-w-7xl mx-auto">
      <div className="px-8">
        <h4
...
export const SkeletonTwo = () => {
  const images = [
   "/contactless.pg", "/retail.jpg", "/b2b.jpg", "/b2b.jpg", "/payment-mode.jpg","/payment-mode.jpg"
