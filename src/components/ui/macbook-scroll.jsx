...
export const MacbookScroll = ({
  ...
  return (
    (<div
      ref={ref}
      className="min-h-[200vh]  flex flex-col items-center py-0 md:py-28 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.35] sm:scale-50">
      <motion.h2
        style={{
          translateY: textTransform,
          opacity: textOpacity,
        }}
        className="dark:text-white text-white text-6xl font-bold mb-20 text-center">
        {title || (
          <span>
          Trusted by Businesses.
            <br />Loved by Developers.
           <br /> No kidding.
          </span>
        )}
      </motion.h2>
